...
const projects = [
  {
    ...
    imageUrl: process.env.PUBLIC_URL+"/Assets/sportinfo.jpg", // Replace with an appropriate image URL
  },
  {
    id: 2,
    ...
    imageUrl: process.env.PUBLIC_URL +"/Assets/gesture.png", // Replace with an appropriate image URL
  },
  {
    id: 3,
    ...
    imageUrl: process.env.PUBLIC_URL+"/Assets/OCR.jpg", // Replace with an appropriate image URL
